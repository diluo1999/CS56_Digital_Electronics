...
HD_PWD='P:/22summer/engs031/group_12/prototype2/Di/Vivado/prototype_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TicTacToe_shell.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TicTacToe_shell.tcl -notrace
