...
HD_PWD='P:/22summer/engs031/group_12/prototype2/Di/Vivado/prototype_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TicTacToe_shell.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TicTacToe_shell.tcl
